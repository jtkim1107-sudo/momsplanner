...
const POSTPARTUM_CATEGORIES = [
  ...
  { nm:'수유 용품', emoji:'🤱', items:[
    ...
    {nm:'모유저장팩 · 네임펜', brands:'스펙트라', ops:[
      {who:'남편찬스맘', verdict:'추천', buy:'스펙트라', txt:'네임펜으로 유축 날짜 적어서 — 조리원 필수'}]},
  ...
  { nm:'아기 용품', emoji:'👶', items:[
    ...
    {nm:'배꼽소독약 · 신생아면봉', brands:'마더케이', ops:[
      {who:'기록왕맘', verdict:'추천', buy:'마더케이', txt:'배꼽 떨어질 때까지 매일 소독'}]},
    {nm:'아기 퇴원복 (계절 확인)', ops:[
  ...
  { nm:'엄마 의류 · 세면', emoji:'👚', items:[
    ...
    {nm:'세면도구 · 가글', ops:[
      {who:'산후8주맘', verdict:'추천', txt:'조리원 비치 여부 확인하고 부족한 것만 챙겨'},
      {who:'기록왕맘', txt:'가글은 새벽 수유 콜 때 은근 유용'}]},
    {nm:'머리끈', ops:[
      {who:'남편찬스맘', verdict:'추천', txt:'안 챙기면 제일 아쉬운 1위 — 수유할 때 머리 묶어야 해요'}]},
    {nm:'수면양말 · 무압박양말', ops:[
      {who:'산후8주맘', verdict:'추천', txt:'산후엔 발이 유독 시려'},
      {who:'기록왕맘', txt:'무압박 양말로 — 발목 조이면 부종 자국 나'}]},
    {nm:'카디건 · 수유 가운', ops:[
      {who:'조리원동기맘', verdict:'추천', txt:'수유실·면회 때 걸치기 좋아'}]},
  ]},
  { nm:'편의 · 전자', emoji:'🔌', items:[
    {nm:'고속충전기 (롱케이블 2m+)', brands:'벨킨 · 삼성', min:true, ops:[
      ...
      {who:'남편찬스맘', buy:'고속충전기'}]},
    {nm:'멀티탭', ops:[
      {who:'남편찬스맘', verdict:'추천', txt:'콘센트 부족 — 두 리스트에 다 등장한 은근 필수템'},
  ...
  { nm:'서류 · 확인', emoji:'📋', items:[
    {nm:'산모수첩 · 신분증 · 지갑', min:true, ops:[
      {who:'조리원동기맘', verdict:'추천', txt:'입소·진료 시 필요'},
      {who:'기록왕맘', txt:'지갑에 신분증 꼭 — 서류 뗄 일 많아'}]},
    {nm:'출생신고 서류 미리 챙기기', ops:[
      {who:'산후8주맘', verdict:'추천', txt:'조리원에 있는 동안 준비해두면 나와서 편해'}]},
    {nm:'조리원 제공품 미리 확인', ops:[
      {who:'산후8주맘', verdict:'추천', txt:'속싸개·좌욕기·유축기·드라이어 — 전화 한 통이면 짐 반으로 줄어'}]},
  ]},
];
