  ...
  hospital: {
    ...
    cats:[
      ...
      { nm:'진통 · 산모', emoji:'👩', avoid:[{nm:'개인 좌욕기', why:'병원·조리원에 다 있어요 — 전화로 확인만 하세요', n:500}], items:[
        ...
        {nm:'세면도구 파우치', ops:[
          {who:'산후8주맘', verdict:'추천', txt:'입원 2~3일 — 칫솔·가글·기초만 작게 싸두세요'}]},
        {nm:'빨대컵 · 텀블러', ops:[
  ...
  nursing: {
    ...
    cats:[
      { nm:'젖병 · 분유', emoji:'🍼', avoid:[{nm:'분유제조기', why:'내부 세척이 어려워 위생 논란 — 보온포트면 충분해요', n:800}], items:[
        ...
        {nm:'분유 보온포트', brands:'보르르 · 쿠쿠', ops:[
          {who:'남편찬스맘', verdict:'추천', buy:'보르르', txt:'새벽 수유 때 40도 물 바로 — 분유파 필수 1위'}]},
        {nm:'쪽쪽이 (공갈젖꼭지)', brands:'필립스 아벤트 · 마더케이', ops:[
          {who:'산후8주맘', verdict:'쏘쏘', txt:'무는 아기·안 무는 아기 갈려 — 하나만 사보고 판단'}]},
      ]},
      { nm:'모유수유', emoji:'🤱', items:[
  ...
  pregnancy: {
    ...
    cats:[
      ...
      { nm:'영양 · 준비', emoji:'💊', items:[
        ...
        {nm:'입덧 완화템 (캔디·손목밴드)', ops:[
          {who:'산후8주맘', verdict:'쏘쏘', txt:'입덧 유무·타입 따라 갈려 — 하나만 사보세요'}]},
  ...
  newborn: {
    ...
    cats:[
      { nm:'목욕 · 위생', emoji:'🛁', avoid:[{nm:'기저귀 휴지통', why:'일반 휴지통+봉투면 충분 — 전용 리필 비용만 계속 나가요', n:1000}], items:[
        ...
        {nm:'후드 목욕타월', brands:'밤부베베 · 콘그', ops:[
          {who:'기록왕맘', verdict:'추천', txt:'목욕 후 바로 감싸기 — 일반 수건보다 훨씬 편해'}]},
        {nm:'손톱가위 · 위생세트', ops:[
