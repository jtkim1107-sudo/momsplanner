...
const BD_CMT_BUY = [
  ...
  '새벽에 급하게 주문해본 사람 여기 있습니다.. 미리 사두세요',
  '친정엄마가 뭘 이런 걸 다 사냐더니 지금 제일 잘 쓰심ㅋㅋ',
  '베이비페어에서 직접 보고 사는 게 제일 나았어요',
  '언박싱할 땐 몰랐는데 100일쯤 되니 진가가 나오네요',
  '살까말까 고민만 3주 했는데 사고 나니 왜 고민했나 싶어요',
  '남편이 제일 반대했던 건데 지금 남편이 제일 잘 씀',
  '저렴이 먼저 써보고 결정해도 늦지 않아요',
  '맘카페에서 하도 난리길래 샀는데 우리 집은 그럭저럭이에요',
  '지역 카페 중고 거래로 반값에 데려왔어요',
  '이건 색깔만 다르게 하나 더 살까 고민 중이에요',
];
const BD_CMT_ACT = [
  ...
  '주수 지나면 못 하는 것들이 진짜 있어요. 오늘 하세요',
  '까먹을까봐 냉장고에 포스트잇 붙여놨었어요ㅋㅋ',
  '시댁 어른들은 모르시는 요즘 제도가 많아요. 직접 챙겨야 해요',
  '출산휴가 들어가기 전에 해두면 마음이 진짜 편해요',
  '동네 맘카페에 물어보니 금방 답 나오더라고요',
  '이건 남편 시키세요. 우리 남편도 했어요',
];
...
function augmentBigData(){
  ...
  SEGMENTS.forEach(seg=>{
    ...
    c.groups.forEach(g=> g.items.forEach(it=>{
      ...
      const cmtCnt = Math.floor(r()*3.4);                           // 0~3개
      if(cmtCnt > 0){
        const used = new Set();
        GEN_COMMENTS[it.id] = [];
