...
// 소행성 육아플래너 — 출산 준비물 시트
// ------------------------------------------------------------
// 선배맘들이 실제로 공유해 쓰는 준비물 자료 3종을 병합해 이식:
...
const SHEET_CATEGORIES = [
  ...
  { nm:'수유용품', emoji:'🍼', items:[
    ...
    {nm:'백색소음기 (수유등)', link:'NC2', brands:'말랑하니', deal:'34,200원'},
...
function renderSheet(){
  ...
  intro.innerHTML = `
    <span class="ri">🛒</span>
    <div class="rc"><h3>선배맘 준비물 자료 3종 병합</h3>
    <p>공유 시트(2025) · 선배맘 A 실사용 리스트 · 호호마더 미니멀 리스트를 합쳤어요.
