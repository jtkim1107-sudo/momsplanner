...
//       link 구간 체크리스트의 같은 아이템 id — 체크 상태를 공유하고
//            구간 아이템 상세에 시트 정보(개수·브랜드·가격·경험담)가 표시됨
// ============================================================

const SHEET_CATEGORIES = [
  { nm:'의류', emoji:'🧥', items:[
    {nm:'배냇저고리', link:'B4', need:'2~3개', note:'입는 시기가 굉장히 짧음 — 아기 몸무게랑 키에 따라 달라짐 (나는 오래 사용했어!)'},
  ...
  { nm:'수유용품', emoji:'🍼', items:[
    ...
    {nm:'젖병+젖꼭지', link:'B2', brands:'더블하트 · 헤겐 · 닥터브라운 · 모윰', deal:'14,000원 (4개)', need:'160ml 6개 · 240ml 4개', note:'완분 기준 160ml 6~8개 추천! 처음엔 160만 쓰니까 240은 차차 추가해도 돼'},
    ...
    {nm:'수유시트 · 쿠션', link:'C3', brands:'더스베이비(수유쿠션) · 알프레미오(수유시트)', carrot:true, prep:true, note:'분유 먹이다 보니 안 쓰게 돼서 추천은 안 해!'},
    ...
    {nm:'쪽쪽이', link:'NC3', brands:'스와비넥스 · 모윰 · 누크 · 아벤트 등', need:'2개', note:'애바애지만 대부분 생후 50일은 지나야 무는 편이래'},
  ]},
  { nm:'피부용품', emoji:'🧴', items:[
  ...
  { nm:'목욕용품', emoji:'🛁', items:[
    {nm:'아기욕조', link:'B8', brands:'슈너글 · 온다베이비', deal:'슈너글 34,900원', need:'1~2개', note:'씻길용·헹굴용 두 개라는데, 신생아는 물로만 씻으니 하나로도 충분해'},
    {nm:'샤워필터'},
    {nm:'바디워시', need:'1개'},
    {nm:'목욕수건', note:'신생아는 일주일에 2번 정도만 씻겨도 된대!'},
    {nm:'천기저귀', brands:'밤부베베 · 무루', deal:'4,817원', need:'5개', note:'샤워 후 수건 대용으로 많이 썼어 — 신생아 땐 블랭킷 대용으로도!'},
  ...
  { nm:'위생용품', emoji:'🧻', items:[
    {nm:'거즈손수건', link:'B13', brands:'밤부베베', need:'50개 이상', note:'1년 이상 쓰는 손수건은 넉넉하게!'},
    {nm:'엠보손수건', brands:'밤부베베'},
    {nm:'지퍼백', brands:'마더케이', note:'출산하러 갈 때 아기 옷 넣어 갔어 — 태어나기 전에 미리 세탁해서 보관해놨어'},
    {nm:'온습도계', link:'B10', brands:'휴비딕', carrot:true, note:'보건소 같은 데서 선물로도 많이 들어오는 편이야'},
    {nm:'체온계', link:'B9', need:'1개', note:'지역 출산축하 선물로 브라운 체온계 받았어!'},
    {nm:'건티슈', brands:'마더케이'},
    {nm:'물티슈', brands:'베베숲 · 브라운', deal:'3만4천원대'},
    {nm:'소독티슈', brands:'그린핑거 · 퓨어닷', deal:'28,740원'},
    {nm:'콧물흡입기', brands:'노시부', prep:true},
    {nm:'손톱가위 · 깎이', link:'B12', brands:'마더케이 · 더블하트(가위)', deal:'7,250원', need:'1개', note:'가위랑 깎이 둘 다 샀어'},
  ...
  { nm:'침구류', emoji:'🛏️', items:[
    {nm:'아기침대', link:'B11', brands:'리안 · 이케아 · 스토케', deal:'18만원대', carrot:true, prep:true, note:'원목·휴대용 등 다양하니 취향대로 — 나는 아직 이동식 쓰고 있어!'},
  ...
  { nm:'외출용품', emoji:'🚗', items:[
    ...
    {nm:'카시트', link:'B1', brands:'브라이텍스 · 다이치 · 맥시코시 · 조이 등', note:'생후 한 달간은 바구니 카시트 추천'},
    {nm:'바구니카시트', carrot:true},
    {nm:'아기띠 · 힙시트', link:'NC5', brands:'포그내 · 코니 · 아이엔젤 · 베이비뵨 등', carrot:true, note:'신생아 시기 이후에 많이 쓰는 편이야!'},
    {nm:'슬링', need:'1개', note:'신생아 시기에만 쓰지만 많이들 쓴대 — 고민 중이야'},
    {nm:'유모차', link:'B14', brands:'오이스터3 · 에그2 · 오르빗 · 부가부 등', carrot:true, note:'6개월 전까지는 디럭스나 절충형 추천'},
    {nm:'유모차패드'},
    {nm:'쿨시트 · 웜시트'},
    {nm:'휴대용 방수패드'},
    {nm:'유모차커버 (방풍 · 레인 등)'},
  ...
  { nm:'발달 · 기타', emoji:'🧸', items:[
    {nm:'모빌 (타이니 등)', link:'NC1', carrot:true, need:'1개', note:'새제품 10만원대, 당근이면 3만원 정도 — 첫만남이용권으로 샀어!'},
    {nm:'초점책', need:'1개'},
    {nm:'아기체육관', link:'GA3', need:'1개', note:'애바애라 잘 안 노는 아가도 있어ㅜ'},
